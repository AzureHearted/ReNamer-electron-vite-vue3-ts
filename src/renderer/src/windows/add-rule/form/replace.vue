<template>
  ...
  >
    <n-form-item class="form-item" label="查找:" path="match">
      <n-input-group>
        <n-input v-model:value="data.match" placeholder="输入要替换的内容" clearable />
...
import { ReNameReplaceRule } from '@common/class/ReNamerRule'
...
//s 表单数据定义
const data = defineModel<ReNameReplaceRule>('data', {
  default: () => {
    // 默认值
    return reactive(new ReNameReplaceRule())
  }
})
</script>
